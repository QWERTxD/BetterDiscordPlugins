...
function buildPlugin([BasePlugin, PluginApi]) {
	...
	(() => {
		...
		const SlateTextAreaContextMenu = get((m => "SlateTextAreaContextMenu" === m?.default?.displayName));
		const ChannelTextAreaContainer = get((m => "ChannelTextAreaContainer" === m?.type?.render?.displayName));
